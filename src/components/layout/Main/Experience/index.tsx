  ...
  const experiences = [
    {
      ...
      year: "2024",
      habilities: [
        "Desenvolvimento de aplicações backend com Node.js | Nest | Fastify",
        "Implementação de Soluções AWS (Cloudfront, API Gateway, Route 53, ECS, SNS, SQS, Lambda, Event Bridger, S3, etc.)",
        ...
        "Observabilidade de microserviços com Grafana e OpenTelemetry",
        "Automação de deploy com GitHub Actions",
        "Implementação de trace de errors com Sentry",
    ...
    },
     {
      ...
      year: "2025",
      habilities: [
        "Arquitetura em nuvem com AWS (Cloudfront, Route 53, ECS, ALB , Security Groups , Amplify , Lightsail, etc.)",
        "Implementação de padronização de commits com Husky, Commitlint e Commitizen",
        "Containerização e deploy de aplicações em produção com Docker",
        "Criação de CI/CD com GitHub Actions",
        "Desenvolvimento de aplicações backend com Laravel",
        "Design de projetos com React + Next",
        "Arquitetura para sass",
